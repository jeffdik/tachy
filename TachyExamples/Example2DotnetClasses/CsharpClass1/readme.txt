...
4. Make sure that the Start Application on the same debugging page as under 3. points to the Visual
Studio version you want to use. For instance:
...
and make this your startup project.
...
3.	Open the Properties window of this startup project and in the debugging page of the 
	Configuration Properties folder, make the following changes:
		...
		c. Set the Start Application to Visual Studio (for instance C:\Program Files\Microsoft Visual Studio .NET 2003\Common7\IDE\devenv.exe)
...
code, to avoid losing changes to your Tachy code.
